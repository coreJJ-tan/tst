...
unsigned long simple_strtoul(const char *cp, char **endp, unsigned int base)
    ...
    返回值: 返回转换后数据.
    * base为0表示通过cp来自动判断基数, 函数自动可识别的基数: '0x' 表示16进制, '0'表示8进制, 其它都认定为10进制, 函数可转换成数字的有效字
符为: [0, f]. 举例: cp = "0x12str",base = 0, 则返回unsigned long long为18, *endp = "str".
// simple_strtol()函数====================================================================================================
